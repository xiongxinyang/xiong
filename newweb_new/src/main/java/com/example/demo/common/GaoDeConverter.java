...
public class GaoDeConverter {
    ...
    double casm_y2 = 0;
    double casm_f = 0;
    private static GaoDeConverter instance = null;
    ...
    public static GaoDeConverter getInstance(){
    	if(instance == null)
    		instance = new GaoDeConverter();
    	return instance;
    }
    ...
    protected GaoDePoint wgtochina_lb(int wg_flag,int wg_lng, int wg_lat, int wg_heit, int wg_week, int wg_time)
    {
    	double  x_add;
    	double  y_add;
    	double  h_add;
    ...
    public GaoDePoint getEncryPoint(double x,double y)
    {
